...
** TODO Chapter extraction
From the descriptions.
- Store these or generate in =elfeed-tube-show=?

** TODO Chapter display
- User option for timestamp chunking
- Formatting this and timestamps simultaneously?

** TODO =imenu= support
Headings:
- All message-header-name fields
- Chapters?
